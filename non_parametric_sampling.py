...
def get_neighboring_pixel_indices(pixel_mask):
    ...
    # plt.show()
    # cv2.imshow('pixel mask', pixel_mask)
    # cv2.waitKey()
    # cv2.imshow('dilate mask', dilated_mask)
    # cv2.waitKey()
    # cv2.imshow('neighbors', neighbors)
    # cv2.waitKey()
...
# def synthesize_texture(original_sample, window_size, kernel_size, visualize=True):
#     global gif_count
...
#     args = parse_args()
#     # args.visualize = True
#     # args.window_height = 500
#     # args.window_width = 500
#     sample_path = r'examples\t5.png'
#     out_path = r'examples\t5_out.png'
